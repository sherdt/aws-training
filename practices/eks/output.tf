...
output "update_kubeconfig" {
  value = "You can update your kubeconfig with the AWS CLI: aws eks --region ${data.aws_region.current.name} update-kubeconfig --name ${aws_eks_cluster.eks.name} --profile XXX"
}
